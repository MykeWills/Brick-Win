var RedBrick = function(stage, assetManager, ball){
    
    "use strict";
    
    // Event listenr for when this brick is hit by ball
    var eventRedBrickHit = new createjs.Event("onRedBrickHit", true);
    ...
    this.updateMe = function(){
        ...
        if (c <= 55){
            ...
            sprite.dispatchEvent(eventRedBrickHit);
            onDestroyed();
        }
    };
